    ...
    return (
      <div className="flex flex-col gap-3" aria-hidden>
        <div className="flex items-start gap-2.5">
          <div className="h-8 w-8 shrink-0 animate-pulse rounded-full bg-ink/6" />
          <div className="flex-1 space-y-2 rounded-2xl rounded-tl-md bg-ink/4 px-3 py-2">
            <div className="h-3 w-16 animate-pulse rounded bg-ink/8" />
            <div className="h-3 w-full animate-pulse rounded bg-ink/8" />
            <div className="h-3 w-2/3 animate-pulse rounded bg-ink/8" />
          </div>
        </div>
        <div className="flex items-start gap-2.5">
          <div className="h-8 w-8 shrink-0 animate-pulse rounded-full bg-ink/6" />
