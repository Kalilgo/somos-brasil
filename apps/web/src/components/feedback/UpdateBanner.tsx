...
export function UpdateBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(6rem+env(safe-area-inset-bottom))] z-[60] flex justify-center px-4 print:hidden">
      <div className="flex max-w-sm items-center gap-3 rounded-full bg-ink py-2 pl-5 pr-2 text-white shadow-card-lg">
        ...
        <button
          ...
          className="min-h-11 rounded-full bg-coral px-4 font-display text-sm font-extrabold text-white transition-transform active:scale-95 focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:outline-none"
        >
          Actualizar
        </button>
        <button
          ...
          className="grid h-11 w-11 place-items-center rounded-full text-ink-soft transition-colors hover:bg-white/10 hover:text-white focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:outline-none"
        >
          ✕
        </button>
      </div>
